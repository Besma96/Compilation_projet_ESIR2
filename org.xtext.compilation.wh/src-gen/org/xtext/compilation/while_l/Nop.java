 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.compilation.while_l.Nop#getNop <em>Nop</em>}</li>
 * </ul>
 *
 * @see org.xtext.compilation.while_l.While_lPackage#getNop()
 * @model
 * @generated
 */
public interface Nop extends EObject
{
   ...
   * @see #setNop(String)
   * @see org.xtext.compilation.while_l.While_lPackage#getNop_Nop()
   * @model
   * @generated
   */
  String getNop();
  ...
  /**
   * Sets the value of the '{@link org.xtext.compilation.while_l.Nop#getNop <em>Nop</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
