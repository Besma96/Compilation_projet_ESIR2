 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.compilation.while_l.impl.AffectImpl#getVars <em>Vars</em>}</li>
 *   <li>{@link org.xtext.compilation.while_l.impl.AffectImpl#getExprs <em>Exprs</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AffectImpl extends MinimalEObjectImpl.Container implements Affect
{
  ...
  {
    return While_lPackage.Literals.AFFECT;
  }
  ...
  public EList<String> getVars()
  {
    if (vars == null)
    {
      vars = new EDataTypeEList<String>(String.class, this, While_lPackage.AFFECT__VARS);
    }
    return vars;
  }
  ...
  public EList<Expr> getExprs()
  {
    if (exprs == null)
    {
      exprs = new EObjectContainmentEList<Expr>(Expr.class, this, While_lPackage.AFFECT__EXPRS);
    }
    return exprs;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case While_lPackage.AFFECT__EXPRS:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case While_lPackage.AFFECT__VARS:
        return getVars();
      case While_lPackage.AFFECT__EXPRS:
        return getExprs();
    }
