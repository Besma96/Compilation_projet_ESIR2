...
//		Set<String> set =  Main.getInstance().getFunList().keySet();
//		 set.forEach((key) -> {
//			 FunctionDef def = Main.getInstance().getFunList().get(key);
//			 def.getVars_local().forEach((varlocal)->{
//				 write(varlocal + " = bt(\"" + varlocal + "\", None, None)");
