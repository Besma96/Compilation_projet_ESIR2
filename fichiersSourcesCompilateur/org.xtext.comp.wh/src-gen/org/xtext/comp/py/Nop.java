 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.comp.py.Nop#getNop <em>Nop</em>}</li>
 * </ul>
 *
 * @see org.xtext.comp.py.PyPackage#getNop()
 * @model
 * @generated
 */
public interface Nop extends EObject
{
   ...
   * @see #setNop(String)
   * @see org.xtext.comp.py.PyPackage#getNop_Nop()
   * @model
   * @generated
   */
  String getNop();
  ...
  /**
   * Sets the value of the '{@link org.xtext.comp.py.Nop#getNop <em>Nop</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
