 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.comp.py.For#getExpr <em>Expr</em>}</li>
 *   <li>{@link org.xtext.comp.py.For#getCmds <em>Cmds</em>}</li>
 * </ul>
 *
 * @see org.xtext.comp.py.PyPackage#getFor()
 * @model
 * @generated
 */
public interface For extends EObject
{
   ...
   * @see #setExpr(Expr)
   * @see org.xtext.comp.py.PyPackage#getFor_Expr()
  ...
  /**
   * Sets the value of the '{@link org.xtext.comp.py.For#getExpr <em>Expr</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.xtext.comp.py.PyPackage#getFor_Cmds()
   * @model containment="true"
   * @generated
   */
  Commands getCmds();
  ...
  /**
   * Sets the value of the '{@link org.xtext.comp.py.For#getCmds <em>Cmds</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
