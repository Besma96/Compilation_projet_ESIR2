 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.comp.py.If#getExpr <em>Expr</em>}</li>
 *   <li>{@link org.xtext.comp.py.If#getCommands1 <em>Commands1</em>}</li>
 *   <li>{@link org.xtext.comp.py.If#getCommands2 <em>Commands2</em>}</li>
 * </ul>
 *
 * @see org.xtext.comp.py.PyPackage#getIf()
 * @model
 * @generated
 */
public interface If extends EObject
{
   ...
   * @see #setExpr(Expr)
   * @see org.xtext.comp.py.PyPackage#getIf_Expr()
  ...
  /**
   * Sets the value of the '{@link org.xtext.comp.py.If#getExpr <em>Expr</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.xtext.comp.py.PyPackage#getIf_Commands1()
   * @model containment="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link org.xtext.comp.py.If#getCommands1 <em>Commands1</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.xtext.comp.py.PyPackage#getIf_Commands2()
   * @model containment="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link org.xtext.comp.py.If#getCommands2 <em>Commands2</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
