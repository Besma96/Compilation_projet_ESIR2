...
import org.xtext.compilation.while_l.While_lFactory;
 ...
 * @generated
 */
public class While_lPackageImpl extends EPackageImpl implements While_lPackage
{
  /**
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.xtext.compilation.while_l.While_lPackage#eNS_URI
   * @see #init()
   * @generated
   */
  private While_lPackageImpl()
  {
    super(eNS_URI, While_lFactory.eINSTANCE);
  }
   ...
   *
   * <p>This method is used to initialize {@link While_lPackage#eINSTANCE} when that field is accessed.
   ...
   * @generated
   */
  public static While_lPackage init()
  {
    if (isInited) return (While_lPackage)EPackage.Registry.INSTANCE.getEPackage(While_lPackage.eNS_URI);

    // Obtain or create and register package
    Object registeredWhile_lPackage = EPackage.Registry.INSTANCE.get(eNS_URI);
    While_lPackageImpl theWhile_lPackage = registeredWhile_lPackage instanceof While_lPackageImpl ? (While_lPackageImpl)registeredWhile_lPackage : new While_lPackageImpl();

    isInited = true;

    // Create package meta-data objects
    theWhile_lPackage.createPackageContents();

    // Initialize created meta-data
    theWhile_lPackage.initializePackageContents();

    // Mark meta-data to indicate it can't be changed
    theWhile_lPackage.freeze();

    // Update the registry and return the package
    EPackage.Registry.INSTANCE.put(While_lPackage.eNS_URI, theWhile_lPackage);
    return theWhile_lPackage;
  }
   ...
   * @generated
   */
  public While_lFactory getWhile_lFactory()
  {
    return (While_lFactory)getEFactoryInstance();
  }
