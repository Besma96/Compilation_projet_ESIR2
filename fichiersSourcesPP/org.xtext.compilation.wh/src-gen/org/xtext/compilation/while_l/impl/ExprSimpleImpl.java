 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.compilation.while_l.impl.ExprSimpleImpl#getStr <em>Str</em>}</li>
 *   <li>{@link org.xtext.compilation.while_l.impl.ExprSimpleImpl#getVarSimple <em>Var Simple</em>}</li>
 *   <li>{@link org.xtext.compilation.while_l.impl.ExprSimpleImpl#getSym <em>Sym</em>}</li>
 *   <li>{@link org.xtext.compilation.while_l.impl.ExprSimpleImpl#getNameFunction <em>Name Function</em>}</li>
 *   <li>{@link org.xtext.compilation.while_l.impl.ExprSimpleImpl#getVars <em>Vars</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ExprSimpleImpl extends MinimalEObjectImpl.Container implements ExprSimple
{
  ...
  {
    return While_lPackage.Literals.EXPR_SIMPLE;
  }
  ...
  public void setStr(String newStr)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, While_lPackage.EXPR_SIMPLE__STR, oldStr, str));
  }
  ...
  public void setVarSimple(String newVarSimple)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, While_lPackage.EXPR_SIMPLE__VAR_SIMPLE, oldVarSimple, varSimple));
  }
  ...
  public void setSym(String newSym)
  {
    ...
    sym = newSym;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, While_lPackage.EXPR_SIMPLE__SYM, oldSym, sym));
  }
  ...
  public void setNameFunction(String newNameFunction)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, While_lPackage.EXPR_SIMPLE__NAME_FUNCTION, oldNameFunction, nameFunction));
  }
  ...
  public NotificationChain basicSetVars(Input newVars, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, While_lPackage.EXPR_SIMPLE__VARS, oldVars, newVars);
  ...
  public void setVars(Input newVars)
  {
    if (newVars != vars)
    {
      ...
      if (vars != null)
        msgs = ((InternalEObject)vars).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - While_lPackage.EXPR_SIMPLE__VARS, null, msgs);
      if (newVars != null)
        msgs = ((InternalEObject)newVars).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - While_lPackage.EXPR_SIMPLE__VARS, null, msgs);
      msgs = basicSetVars(newVars, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, While_lPackage.EXPR_SIMPLE__VARS, newVars, newVars));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case While_lPackage.EXPR_SIMPLE__VARS:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case While_lPackage.EXPR_SIMPLE__STR:
        return getStr();
      case While_lPackage.EXPR_SIMPLE__VAR_SIMPLE:
        return getVarSimple();
      case While_lPackage.EXPR_SIMPLE__SYM:
        return getSym();
      case While_lPackage.EXPR_SIMPLE__NAME_FUNCTION:
