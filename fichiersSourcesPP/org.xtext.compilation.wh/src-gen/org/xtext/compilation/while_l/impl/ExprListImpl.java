 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.compilation.while_l.impl.ExprListImpl#getArg <em>Arg</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ExprListImpl extends MinimalEObjectImpl.Container implements ExprList
{
  ...
  {
    return While_lPackage.Literals.EXPR_LIST;
  }
  ...
  public EList<Expr> getArg()
  {
    if (arg == null)
    {
      arg = new EObjectContainmentEList<Expr>(Expr.class, this, While_lPackage.EXPR_LIST__ARG);
    }
    return arg;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case While_lPackage.EXPR_LIST__ARG:
