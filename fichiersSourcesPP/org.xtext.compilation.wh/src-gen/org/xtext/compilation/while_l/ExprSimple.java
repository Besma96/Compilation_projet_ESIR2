 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.compilation.while_l.ExprSimple#getStr <em>Str</em>}</li>
 *   <li>{@link org.xtext.compilation.while_l.ExprSimple#getVarSimple <em>Var Simple</em>}</li>
 *   <li>{@link org.xtext.compilation.while_l.ExprSimple#getSym <em>Sym</em>}</li>
 *   <li>{@link org.xtext.compilation.while_l.ExprSimple#getNameFunction <em>Name Function</em>}</li>
 *   <li>{@link org.xtext.compilation.while_l.ExprSimple#getVars <em>Vars</em>}</li>
 * </ul>
 *
 * @see org.xtext.compilation.while_l.While_lPackage#getExprSimple()
 * @model
 * @generated
 */
public interface ExprSimple extends EObject
{
   ...
   * @see #setStr(String)
   * @see org.xtext.compilation.while_l.While_lPackage#getExprSimple_Str()
   * @model
   * @generated
   */
  String getStr();
  ...
  /**
   * Sets the value of the '{@link org.xtext.compilation.while_l.ExprSimple#getStr <em>Str</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.xtext.compilation.while_l.While_lPackage#getExprSimple_VarSimple()
   * @model
   * @generated
   */
  String getVarSimple();
  ...
  /**
   * Sets the value of the '{@link org.xtext.compilation.while_l.ExprSimple#getVarSimple <em>Var Simple</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see #setSym(String)
   * @see org.xtext.compilation.while_l.While_lPackage#getExprSimple_Sym()
   * @model
   * @generated
   */
  String getSym();
  ...
  /**
   * Sets the value of the '{@link org.xtext.compilation.while_l.ExprSimple#getSym <em>Sym</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.xtext.compilation.while_l.While_lPackage#getExprSimple_NameFunction()
   * @model
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link org.xtext.compilation.while_l.ExprSimple#getNameFunction <em>Name Function</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see #setVars(Input)
   * @see org.xtext.compilation.while_l.While_lPackage#getExprSimple_Vars()
  ...
  /**
   * Sets the value of the '{@link org.xtext.compilation.while_l.ExprSimple#getVars <em>Vars</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
