 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.comp.py.impl.AffectImpl#getVars <em>Vars</em>}</li>
 *   <li>{@link org.xtext.comp.py.impl.AffectImpl#getExprs <em>Exprs</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AffectImpl extends MinimalEObjectImpl.Container implements Affect
{
  ...
  {
    return PyPackage.Literals.AFFECT;
  }
  ...
  public EList<String> getVars()
  {
    if (vars == null)
    {
      vars = new EDataTypeEList<String>(String.class, this, PyPackage.AFFECT__VARS);
    }
    return vars;
  }
  ...
  public EList<Expr> getExprs()
  {
    if (exprs == null)
    {
      exprs = new EObjectContainmentEList<Expr>(Expr.class, this, PyPackage.AFFECT__EXPRS);
    }
    return exprs;
  }
