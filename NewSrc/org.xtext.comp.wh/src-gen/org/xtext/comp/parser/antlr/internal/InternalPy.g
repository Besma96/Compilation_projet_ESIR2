...
// Entry rule entryRuleFunctionP
entryRuleFunctionP returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getFunctionPRule()); }
	iv_ruleFunctionP=ruleFunctionP
	{ $current=$iv_ruleFunctionP.current; }
	EOF;

// Rule FunctionP
ruleFunctionP returns [EObject current=null]
@init {
	enterRule();
}
@after {
