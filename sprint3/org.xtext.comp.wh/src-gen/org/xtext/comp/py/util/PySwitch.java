 ...
 * @generated
 */
public class PySwitch<T> extends Switch<T>
{
  /**
  ...
  protected T doSwitch(int classifierID, EObject theEObject)
  {
    switch (classifierID)
    {
      ...
      {
        FunctionP functionP = (FunctionP)theEObject;
        T result = caseFunctionP(functionP);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
   ...
   * @generated
   */
  public T caseFunctionP(FunctionP object)
  {
    return null;
  }
