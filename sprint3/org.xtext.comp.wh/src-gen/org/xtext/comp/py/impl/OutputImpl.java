 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.comp.py.impl.OutputImpl#getVars <em>Vars</em>}</li>
 * </ul>
 *
 * @generated
 */
public class OutputImpl extends MinimalEObjectImpl.Container implements Output
{
  ...
  {
    return PyPackage.Literals.OUTPUT;
  }
  ...
  public EList<String> getVars()
  {
    if (vars == null)
    {
      vars = new EDataTypeEList<String>(String.class, this, PyPackage.OUTPUT__VARS);
    }
    return vars;
  }
