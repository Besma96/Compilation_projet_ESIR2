...
public class ExprImpl extends MinimalEObjectImpl.Container implements Expr
{
  ...
  {
    return PyPackage.Literals.EXPR;
  }
  ...
  public NotificationChain basicSetExpr(EObject newExpr, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, PyPackage.EXPR__EXPR, oldExpr, newExpr);
  ...
  public void setExpr(EObject newExpr)
  {
    if (newExpr != expr)
    {
      ...
      if (expr != null)
        msgs = ((InternalEObject)expr).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - PyPackage.EXPR__EXPR, null, msgs);
      if (newExpr != null)
        msgs = ((InternalEObject)newExpr).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - PyPackage.EXPR__EXPR, null, msgs);
      msgs = basicSetExpr(newExpr, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, PyPackage.EXPR__EXPR, newExpr, newExpr));
  }
